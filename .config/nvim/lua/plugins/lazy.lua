...
require("lazy").setup({
  ...
  { import = "plugins.ui.lualine" },  -- status bar - bottom bar
  { import = "plugins.workflow.telescope" },  -- telescope.nvim, search, keymaps, ...
  { import = "plugins.workflow.workspaces" },  -- "natecraddock/workspaces.nvim", workspaces ...
  { import = "plugins.workflow.sessions" },  -- "natecraddock/sessions.nvim", session for workspaces ...
  ...
  { import = "plugins.workflow.todo-comments" },  -- todo-comments.nvim, show todo comment ...
