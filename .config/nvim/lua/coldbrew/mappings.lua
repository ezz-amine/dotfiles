...
--  - togglee tab bar
set('n', '<leader>bt', function() vim.opt.showtabline = vim.opt.showtabline == 2 and 0 or 2 end,
    { desc = '[B]uffer [T]oggle tabline' })
...
--  - because i'm lazy
set('i', '<C-v>', '<C-r>+', { noremap = true, desc = 'Paste from system clipboard' })
...
set('i', '<C-z>', '<C-o>u', { noremap = true, desc = 'Undo in insert mode' })
set('i', '<C-y>', '<C-o><C-r>', { noremap = true, desc = 'Redo in insert mode' })
...
-- set("n", "<Tab>", ":BufferLineCycleNext<CR>", { silent = true, desc = "Next tab" })
-- set("n", "<S-Tab>", ":BufferLineCyclePrev<CR>", { silent = true, desc = "Previous tab" })
set("n", "<leader>x", ":bdelete<CR>", { silent = true, desc = "Close buffer" })

-- code completion
-- local luasnip = require("luasnip")
-- set('i', '<C-Space>', function() luasnip.jump(50) end, { noremap = true, silent = true })
-- set('s', '<C-Space>', function() luasnip.jump(50) end, { noremap = true, silent = true })
...
-- comment/uncomment
set({ "n", "v" }, "<leader>/", ":Commentary<CR>", { silent = true, desc = "Toggle comment" })
...
set({ "n", "v" }, "<leader>gd", ":Telescope lsp_definitions<cr>", { desc = "code lsp_definitions" })
set("n", "<leader>op", ":Telescope brew_sessions<cr>", { desc = "show brew projects/sessions" })
...
set("n", "<leader>ah", function() harpoon:list():add() end)
